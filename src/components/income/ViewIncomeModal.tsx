    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            <div
                ...
                onClick={onClose}
            />
            <div className="relative bg-white dark:bg-[#18181B] rounded-xl shadow-xl w-full max-w-xl mx-4 max-h-[90vh] flex flex-col">
                {/* Header */}
                ...
                <div className="p-4 overflow-auto">
                    {loading ? (
                        <div className="py-8 text-center text-gray-500 dark:text-[#A1A1AA]">
                            Loading...
                        </div>
                    ) : error ? (
                        ...
                        <div className="grid grid-cols-2 gap-4 text-sm">
                            <div>
                                <div className="text-gray-500 dark:text-[#A1A1AA] text-xs mb-1">
                                    Amount
                                </div>
                            ...
                            <div>
                                ...
                                <div className="capitalize text-gray-900 dark:text-[#FAFAFA]">
                                    {record.source || "-"}
                                </div>
                            </div>
                            <div>
                                ...
                                <div className="uppercase text-gray-900 dark:text-[#FAFAFA]">
                            ...
                            <div>
                                ...
                                <div className="text-gray-900 dark:text-[#FAFAFA]">
                                    {displayDate}
                                </div>
                            </div>
